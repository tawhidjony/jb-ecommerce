      ...
      <div class="container">
        ...
        <div class="row margin-none">
          <a href="search-result.html" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/electronics.png')}}" alt="">
            </div>
            <span>Electronics</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/mobile.png')}}" alt="">
            </div>
            <span>Smart Phones</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/camera.png')}}" alt="">
            </div>
            <span>Cameras & Photo</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/women.png')}}" alt="">
            </div>
            <span>Women's Fashion</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/men.png')}}" alt="">
            </div>
            <span>Men's Fashion</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/beauty.png')}}" alt="">
            </div>
            <span>Healthy & Beauty</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/gift.png')}}" alt="">
            </div>
            <span>Gift Ideas</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/game.png')}}" alt="">
            </div>
            <span>Toy & Games</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/cooking.png')}}" alt="">
            </div>
            <span>Cooking</span>
          </a>
          <a href="#" class="item-box d-flex">
            <div class="img-area">
              <img src="{{URL::to('frontend/assets/images/categories/assesorise.png')}}" alt="">
            </div>
            ...
            <!-- single product card end -->
                ...
                <div class="col-6 col-lg-3 col-md-4 col-sm-6">
                  <a href="product-details.html">
                    <div class="product-card">
                      <div class="product-image-area">
                        <img src="{{URL::to('fronent/assets/images/product-img/product-3/laptop-main.png')}}" alt="">
                      </div>
                      <div class="product-heading">
                        <h4>MacBook Pro, 16-inch,10-Core CPU 16-Core GPU, 16GB Unified Memory, 1TB SSD Storage¹. </h4>
                      </div>
